...
# The Final, Correct Guide to Deploying Your App

Hello! I am very sorry for the previous errors. This guide has the final, corrected instructions and code. Please follow this one.

### **Part 1: Get Your Secret API Key**

*   Go to [https://aistudio.google.com/app/apikey](https://aistudio.google.com/app/apikey)
*   Click **"Create API key in new project"**.
*   Copy the key and save it somewhere safe, like in Notepad. You will need it at the very end.

---

### **Part 2: Create Your Project on GitHub**

1.  Go to [github.new](https://github.new) to create a new, empty project.
2.  For "Repository name", type `pdf-extractor-app`.
3.  Click the green **"Create repository"** button.

You are now on your project's page. We will now create all the files by copying and pasting.

---

### **Part 3: Create Every File Your App Needs**

For each of the files listed below, repeat these actions:

*   On your GitHub project page, click **"Add file"** -> **"Create new file"**.
*   In the "Name your file..." box, type the **File Name** exactly as you see it below.
*   Copy the entire code block from the **Content** section.
*   Paste it into the big text box on GitHub.
*   Click the green **"Commit new file"** button.

**File 1: `index.html` (at the top level)**
...
**File 3: `vite.config.ts` (This one is simpler now!)**
...
**File 4: `api/extract.ts`**
*   **File Name:** `api/extract.ts`
*   **Content:**
    ```typescript
...
*   **Content:** (This is the same large file as before)
    ```typescript
...
*   **Content:**
    ```typescript
    export const noto_sans_devanagari_regular_base64 = '';
    ```

**File 9 - 12 are configuration files. Just copy and paste.**

**File 9: `tailwind.config.js`**
...
After you have created all 12 files on GitHub, your project is ready.

1.  **Go to Vercel:** [Click here to go to your Vercel dashboard](https://vercel.com/dashboard).
2.  Click **"Add New..."** -> **"Project"**.
3.  Find your `pdf-extractor-app` repository and click **"Import"**.
...
That's it! Vercel will build your website. In about two minutes, it will be live on the internet.
