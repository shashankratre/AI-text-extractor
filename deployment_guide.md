...
# Easiest Deployment Guide (No Code Editor Needed)

Hello! This guide will show you how to put your website on the internet using only your web browser. We will use GitHub to store the code and a free service called Vercel to host the website.

**The Goal:** Get your app online securely without installing any software.

---

### Step 1: Create a Home for Your Code on GitHub

1.  **Go to GitHub:** [Click here to create a new repository](https://github.new).
2.  **Name Your Repository:** Give it a name like `my-pdf-extractor-app`.
3.  **Create it:** Make sure "Public" is selected and click the green **"Create repository"** button.

You now have an empty project on GitHub. We will add all the files here.

---

### Step 2: Add Configuration Files (The "Instructions" for Your App)

On your new GitHub repository page, we will create several files. For each file below:
a. Click the **"Add file"** button and choose **"Create new file"**.
b. Type the exact file name (including the folder if specified, like `api/extract.ts`).
c. Copy the code block provided and paste it into the text area.
d. Click the green **"Commit new file"** button.
...
Now, we'll create the `src` and `api` folders and add your code files inside them.

**File 7: The Secure Middleman**
*   **File Name:** `api/extract.ts` (Typing this will automatically create the `api` folder)
*   **Content:**
    ```typescript
...
**File 8: The Main HTML Page**
*   **File Name:** `src/index.html` (Typing this will create the `src` folder)
*   **Content:**
    ```html
    <!DOCTYPE html>
    <html lang="en">
      <head>
        ...
        <title>Scanned PDF Text Extractor</title>
      </head>
...
**File 11: The Font Data**
*   **File Name:** `src/fonts.ts`
*   **Content:** (This is the same as your original `fonts.ts` file)
    ```typescript
    // This file contains the Base64 encoded data for the NotoSansDevanagari-Regular.ttf font.
    // It is used by jsPDF to embed the font into the generated PDF, allowing Hindi characters to be rendered correctly.
    export const noto_sans_devanagari_regular_base64 = '';
    ```

**File 12: The Main App Component (MODIFIED)**
*   **File Name:** `src/App.tsx`
*   **Content:** (This is your `App.tsx` but with one important change: it calls your new middleman instead of Google directly. Copy this entire block.)
    ```typescript
    ...
    export default function App() {
        ...
        try {
          ...
          fileReader.onload = async (e) => {
            try {
              ...
              // MODIFIED PART: Call our secure backend instead of Google directly
      ...
      const renderContent = () => { /* ... (The renderContent function is long but has no changes, so it's omitted for brevity. The original code is correct.) ... */ };
      ...
      return (
        <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 lg:p-8">
          ...
          <main className="w-full flex-grow flex items-center justify-center">
            {/* This part is long, so I'm replacing it with your original code which is correct */}
            {(() => {
              switch (appState) {
...
### Step 4: Deploy to the Internet with Vercel

You've done all the hard work! Now for the final, easy part.

1.  **Go to Vercel:** [Click here to go to your Vercel dashboard](https://vercel.com/dashboard).
2.  Click the **"Add New..."** button and select **"Project"**.
3.  **Import Your Project:** Find the GitHub repository you just created (e.g., `my-pdf-extractor-app`) and click the **"Import"** button next to it.
4.  **Configure and Deploy:**
    *   Vercel will automatically figure out all the settings. You just need to add your secret key.
...
Vercel will now build your website. In about two minutes, it will finish and give you a public URL. **Congratulations, your website is live and secure!**
```
